...
/// is responsible for any additional configuration that is requred in the message.
/// @param roboplan_trajectory The roboplan JointTrajectory to convert
/// @return An equivalent ROS 2 JointTrajectory message.
inline trajectory_msgs::msg::JointTrajectory toJointTrajectory(
    const roboplan::JointTrajectory& roboplan_trajectory) {
...
/// @brief Convert the provided ROS 2 JointTrajectory message to an equivalent roboplan::JointTrajectory.
/// @param ros_trajectory The ROS 2 JointTrajectory message to convert.
/// @return An equivalent roboplan::JointTrajectory.
inline roboplan::JointTrajectory fromJointTrajectory(
