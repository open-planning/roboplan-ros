...
def se3ToPose(
    transform: Annotated[NDArray[numpy.float64], dict(shape=(4, 4), order="F")],
) -> object:
...
def buildConversionMap(
    py_scene: object, py_joint_state: object
...
def fromJointState(
    py_joint_state: object, py_scene: object, conversion_map: JointStateConverterMap
